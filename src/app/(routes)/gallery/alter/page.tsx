  ...
  if (notFound) {
    return (
      <div className="container mx-auto max-w-2xl px-4 py-20 text-center">
        <h1 className="text-2xl font-semibold">Gallery piece not found</h1>
...
export default function AlterGalleryPage() {
  return (
    <Suspense fallback={<Spinner fullScreen label="Loading piece..." />}>
      <AlterGalleryForm />
    </Suspense>
  );
}
